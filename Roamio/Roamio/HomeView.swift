        ...
        HStack {
            HStack {
                Image(systemName: "gift.fill")
                    .font(.title3)
                    .padding(10)
                    .background(RoundedRectangle(cornerRadius: 10).fill(Color(hex: "84CEF4").opacity(0.15)))
                    ...
                    ForEach(selectedTab == "Recommended" ? recommendedItems : nearbyItems) { item in
                        VStack(alignment: .leading, spacing: 8) {
                            Rectangle()
                                ...
                                .frame(height: 120)
                                .overlay(
                                    Text(item.imageName) // replace with Image(item.imageName) if you add assets
                                        .foregroundColor(.white)
                                )
                                .cornerRadius(12)
